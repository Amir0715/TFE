...
namespace TFE.Infrastructure.Migrations
{
    ...
    [Migration("20230108230041_AddAuthorOfTest")]
    partial class AddAuthorOfTest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TFE.Domain.Entities.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TFE.Domain.Entities.Test", b =>
                {
                    b.HasOne("TFE.Domain.Entities.UserProfile", "AuthorProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("TFE.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.HasOne("TFE.Domain.Entities.UserProfile", "UserProfile")
                        .WithMany()
